...
## 1. Request Parameters  
    ...
    Name: monterrey_Centro_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:26:35.149794  

    ID: 92164451-dde4-43ff-a84c-f6c570302663  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Centro-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Centro-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Centro-phenology-2005-2024-request.json
- xml file
  - monterrey-Centro-phenology-2005-2024-MCD12Q2-061-metadata.xml  
