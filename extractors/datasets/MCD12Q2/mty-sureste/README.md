...
## 1. Request Parameters  
    ...
    Name: monterrey_Sureste_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:29:17.310769  

    ID: 74e7074b-e26e-4b29-b8f8-27dac1e523a9  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Sureste-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Sureste-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Sureste-phenology-2005-2024-request.json
- xml file
  - monterrey-Sureste-phenology-2005-2024-MCD12Q2-061-metadata.xml  
