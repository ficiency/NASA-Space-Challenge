...
## 1. Request Parameters  
    ...
    Name: monterrey_Noreste_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:29:09.910424  

    ID: ebdd6b4d-0e17-405f-b998-c7ce5d1e63e6  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Noreste-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Noreste-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Noreste-phenology-2005-2024-request.json
- xml file
  - monterrey-Noreste-phenology-2005-2024-MCD12Q2-061-metadata.xml  
