...
## 1. Request Parameters  
    ...
    Name: monterrey_Noroeste_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:29:14.300250  

    ID: b603a7ca-9b1e-4ad4-a193-5ce8207cacec  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Noroeste-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Noroeste-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Noroeste-phenology-2005-2024-request.json
- xml file
  - monterrey-Noroeste-phenology-2005-2024-MCD12Q2-061-metadata.xml  
