...
## 1. Request Parameters  
    ...
    Name: monterrey_Norte_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:26:41.786264  

    ID: 15cb0f95-0ea7-42a9-8978-6b5ed4f6c2a2  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Norte-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Norte-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Norte-phenology-2005-2024-request.json
- xml file
  - monterrey-Norte-phenology-2005-2024-MCD12Q2-061-metadata.xml  
