...
## 1. Request Parameters  
    ...
    Name: monterrey_Oeste_phenology_2005_2024  

    Date Completed:** 2025-10-04T22:28:17.447262  

    ID: 92166279-9eec-4055-9c8e-33c6ccf23281  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Oeste-phenology-2005-2024-MCD12Q2-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Oeste-phenology-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Oeste-phenology-2005-2024-request.json
- xml file
  - monterrey-Oeste-phenology-2005-2024-MCD12Q2-061-metadata.xml  
