...
## 1. Request Parameters  
    ...
    Name: monterrey_Noroeste_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:43:43.420174  

    ID: 320a09e8-0b97-48d7-b342-a9e70a3e7a93  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Noroeste-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Noroeste-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Noroeste-ndvi-2005-2024-request.json
- xml file
  - monterrey-Noroeste-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
