...
## 1. Request Parameters  
    ...
    Name: monterrey_Sureste_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:43:50.340852  

    ID: 51175032-40b3-428d-b241-a6a4d4022473  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Sureste-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Sureste-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Sureste-ndvi-2005-2024-request.json
- xml file
  - monterrey-Sureste-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
