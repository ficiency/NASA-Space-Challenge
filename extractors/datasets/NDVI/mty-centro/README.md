...
## 1. Request Parameters  
    ...
    Name: monterrey_Centro_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:42:20.406166  

    ID: 8f9c3a45-103f-4e42-96de-28396a97f5b8  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Centro-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Centro-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Centro-ndvi-2005-2024-request.json
- xml file
  - monterrey-Centro-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
