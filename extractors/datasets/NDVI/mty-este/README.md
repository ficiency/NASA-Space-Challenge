...
## 1. Request Parameters  
    ...
    Name: monterrey_Este_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:43:39.453649  

    ID: 73677a1b-84ab-4b3e-aa0c-ca80cb9b8982  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Este-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Este-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Este-ndvi-2005-2024-request.json
- xml file
  - monterrey-Este-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
