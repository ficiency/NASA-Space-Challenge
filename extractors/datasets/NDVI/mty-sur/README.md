...
## 1. Request Parameters  
    ...
    Name: monterrey_Sur_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:43:35.475539  

    ID: e51e360d-0b16-40dd-ae67-fee8cf15d3c0  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Sur-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Sur-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Sur-ndvi-2005-2024-request.json
- xml file
  - monterrey-Sur-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
