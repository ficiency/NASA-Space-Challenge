...
## 1. Request Parameters  
    ...
    Name: monterrey_Norte_ndvi_2005_2024  

    Date Completed:** 2025-10-05T00:43:31.680151  

    ID: 4dd4d4df-e699-4d40-80fd-32073dc07f59  
...
- Comma-separated values file with data extracted for a specific product
  - monterrey-Norte-ndvi-2005-2024-MOD13Q1-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - monterrey-Norte-ndvi-2005-2024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - monterrey-Norte-ndvi-2005-2024-request.json
- xml file
  - monterrey-Norte-ndvi-2005-2024-MOD13Q1-061-metadata.xml  
